package Ejercicios.Argumentos;

import java.io.*;

public class Lanzador {
    public static void main(String[] args) throws  IOException, IOException {
        File directorio = new File(".\\out\\production\\EjerciciosProcesos\\");
        ProcessBuilder pb = new ProcessBuilder("java", "Ejercicios.Argumentos.Principal", "2", "5", "hola");
