...
public class Ej2MetodoBurbuja {
    ...
    public static void main(String[] args) {
        ...
        int numero[] = new int[MetodoEj2MetodoBurbuja.longitud()];
        //Para pedr al usuario que ponga el raking de 0-7 posciones
        MetodoEj2MetodoBurbuja.ingresarRaking(teclado,numero);
        //Para ordenar el raking mediante método burbuja de mayor a menor
        MetodoEj2MetodoBurbuja.ordenarRakingBurbuja(numero);
        //Para mostrar el resultado del raking
        MetodoEj2MetodoBurbuja.mostrarRaking(numero);
    }
}
